console.log("🚀 ContDocs JS carregando...");
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const currentModuleTitle = app?.dataset.moduleTitle || "ContDocs";
  const currentModuleSubtitle =
    app?.dataset.moduleSubtitle || "Centralização e gestão de documentos.";
